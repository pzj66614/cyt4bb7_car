...
void imu_fusion_update(IMU_Angles_t *out, float dt)
{
    ...
    // 卡尔曼滤波每轴，所有值保持度制
    kalman_update(dt, gx, roll_m, &angle_roll, &bias_roll, P_roll);
    kalman_update(dt, gy, pitch_m, &angle_pitch, &bias_pitch, P_pitch);
